...
var fileName=String(String(location.pathname.split("/").slice(-1)).split('.').slice(0,-1)); //gets the file name 
...
function basketSize(){
    ...
    if(fileName=="index" && window.innerWidth<1920){
        basCon.style.marginTop="-49.5%";
    }
    else if(fileName=="signIn"  && window.innerWidth<1920){
        basCon.style.marginTop="-53.1%";
    }
    else if(fileName=="LogIn"  && window.innerWidth<1920){
        basCon.style.marginTop="-36.55%";
    }

    //for mobile view 
    if(fileName=="index" && window.innerWidth<720){
    ...
    //for desktop view 
    if(fileName=="index" && window.innerWidth>=1920){
        basCon.style.marginTop="-41.2%";
    }
    else if(fileName=="signIn"  && window.innerWidth>=1920){
        basCon.style.marginTop="-44%";
    }
    else if(fileName=="LogIn"  && window.innerWidth>=1920){
        basCon.style.marginTop="-31.55%";
    }
